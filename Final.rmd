...
Both treatment and subgroups sex(male/female), LGBTQ, DrugUser are categorical variables. Therefore, the method of analysis technique used is cat~cat. I will use a bar chart for graphical results , a cross table for numerical results, a chi-square test and fisher exact test for inference.  
